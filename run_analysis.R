...
# This script depends on metadata script which has all the helper functions
source("./run_analysis_metadata.R")

data_path = "./Dataset/UCIHARDataset"
...
#observations
total_data = merge_data(data_path, train_data_file,test_data_file)
#labels
total_labels = merge_data(data_path, train_label_file,test_label_file)
#subjects 
total_subjects = merge_data(data_path,train_subject_file,test_subject_file)
...
cols_to_keep= cols[[1]]# select the given columns as needed
